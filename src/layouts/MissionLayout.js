import "../pages/Mission/MissionManage.css"
            ...
            <div className="main">
                ...
                <div className="body">
                    ...
                    <div className="body_button">
                        ...
                        <div className="body_button_data">미션 등록하기</div>
                    </div>
                    <div className="body_filter_box">
                        ...
                        <img
                            ...
                            className="my-auto ml-5 w-2 aspect-[2] fill-slate-400"
                        />
                    </div>
                    <div className="body_table">
                        <div className="body_table_topbar">
                            ...
                            <div className="body_table_topbar_data">달성 여부</div>
                        </div>
