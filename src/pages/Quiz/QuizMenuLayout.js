        ...
        <div className="upper-nav">
          ...
          <div className="nav_login">
            ...
            <div className="nav_data">
              <div className="nav_nickname">User Name</div>
              <div className="nav_ID">ID: 1234567</div>
            </div>
